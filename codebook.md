...
The data set produced by running the 'run_analysis.R' see the [ReadMe](https://github.com/highsineburgh/coursera-clean-data/blob/master/README.md) for details. The script produces the following variables:
